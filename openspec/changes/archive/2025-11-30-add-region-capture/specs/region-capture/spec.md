...
Provides the ability to capture arbitrary rectangular regions of the screen, with support for multi-monitor setups and an interactive selection overlay.
...
The system SHALL allow the user to switch between window capture and region capture modes.
