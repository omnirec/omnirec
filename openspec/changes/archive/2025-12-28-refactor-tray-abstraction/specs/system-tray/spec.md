...
Provides cross-platform system tray integration for quick-access recording controls. The tray icon appears in the system notification area (Windows), menu bar (macOS), or app indicator area (Linux), allowing users to start/stop recordings and access application settings without the main window.
...
#### Scenario: Windows stub implementation

- **GIVEN** the Windows tray implementation is a stub
