...
**Download packages**
- Windows: [OmniRec_0.2.0_x64-setup.exe](https://github.com/omnirec/omnirec/releases/download/v0.2.0/OmniRec_0.2.0_x64-setup.exe)
- macOS (Apple Silicon M-Series): [OmniRec_aarch64.dmg](https://github.com/omnirec/omnirec/releases/download/v0.2.0/OmniRec_aarch64.dmg)
- macOS (Legacy Intel x64): [OmniRec_x64.dmg](https://github.com/omnirec/omnirec/releases/download/v0.2.0/OmniRec_x64.dmg)
<!-- release-links:end -->
